...
func RegisterBlobUploadServer(s grpc.ServiceRegistrar, srv BlobUploadServer) {
	// If the following call panics, it indicates UnimplementedBlobUploadServer was
...
const (
	...
	BlobDownload_DownloadSignatureByID_FullMethodName = "/internal.BlobDownload/DownloadSignatureByID"
)
...
type BlobDownloadClient interface {
	...
	DownloadSignatureByID(ctx context.Context, in *BlobSignatureDownloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SignatureContent], error)
}
...
func (c *blobDownloadClient) DownloadSignatureByID(ctx context.Context, in *BlobSignatureDownloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SignatureContent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BlobDownload_ServiceDesc.Streams[1], BlobDownload_DownloadSignatureByID_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BlobSignatureDownloadRequest, SignatureContent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BlobDownload_DownloadSignatureByIDClient = grpc.ServerStreamingClient[SignatureContent]
...
type BlobDownloadServer interface {
	...
	DownloadSignatureByID(*BlobSignatureDownloadRequest, grpc.ServerStreamingServer[SignatureContent]) error
...
func (UnimplementedBlobDownloadServer) DownloadByID(*BlobDownloadRequest, grpc.ServerStreamingServer[BlobContent]) error {
	return status.Error(codes.Unimplemented, "method DownloadByID not implemented")
}
func (UnimplementedBlobDownloadServer) DownloadSignatureByID(*BlobSignatureDownloadRequest, grpc.ServerStreamingServer[SignatureContent]) error {
	return status.Error(codes.Unimplemented, "method DownloadSignatureByID not implemented")
}
...
func RegisterBlobDownloadServer(s grpc.ServiceRegistrar, srv BlobDownloadServer) {
	// If the following call panics, it indicates UnimplementedBlobDownloadServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _BlobDownload_DownloadSignatureByID_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlobSignatureDownloadRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BlobDownloadServer).DownloadSignatureByID(m, &grpc.GenericServerStream[BlobSignatureDownloadRequest, SignatureContent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BlobDownload_DownloadSignatureByIDServer = grpc.ServerStreamingServer[SignatureContent]
...
var BlobDownload_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "DownloadSignatureByID",
			Handler:       _BlobDownload_DownloadSignatureByID_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "internal/service.proto",
...
func (UnimplementedBlobMetadataServer) ListMetadata(*BlobMetaQuery, grpc.ServerStreamingServer[BlobMetaResponse]) error {
	return status.Error(codes.Unimplemented, "method ListMetadata not implemented")
}
func (UnimplementedBlobMetadataServer) GetMetadataByID(context.Context, *IdRequest) (*BlobMetaResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMetadataByID not implemented")
}
...
func RegisterBlobMetadataServer(s grpc.ServiceRegistrar, srv BlobMetadataServer) {
	// If the following call panics, it indicates UnimplementedBlobMetadataServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterCryptoKeyUploadServer(s grpc.ServiceRegistrar, srv CryptoKeyUploadServer) {
	// If the following call panics, it indicates UnimplementedCryptoKeyUploadServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
type CryptoKeyDownloadClient interface {
	// Download crypto key by ID (returns PEM format)
...
func RegisterCryptoKeyDownloadServer(s grpc.ServiceRegistrar, srv CryptoKeyDownloadServer) {
	// If the following call panics, it indicates UnimplementedCryptoKeyDownloadServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterCryptoKeyMetadataServer(s grpc.ServiceRegistrar, srv CryptoKeyMetadataServer) {
	// If the following call panics, it indicates UnimplementedCryptoKeyMetadataServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
